  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="grid size-3 scale-[0.25] place-items-center text-neutral-950 opacity-0 blur-[4px] transition-[opacity,scale,filter] duration-200 ease-[cubic-bezier(0.2,0,0,1)] data-[checked]:scale-100 data-[checked]:opacity-100 data-[checked]:blur-0"
      >
